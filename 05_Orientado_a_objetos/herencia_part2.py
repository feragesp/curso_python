...
class Bateria:
    """Va a representar la bateria de un coche electrico"""
    ...
    def especificaciones_bateria(self):
        """Imprime las especificaciones de la bateria"""
...
telsa_modelS = CocheElectrico("Tesla", "Model S", 360, 280, 15, bateria_tesla_modelS)

telsa_modelS.especificaciones()
telsa_modelS.detalles_bateria()
